...
@ComponentScan({ "ec.edu.upse.proyinv.modelo" })
@EnableJpaRepositories(basePackages = "ec.edu.upse.proyinv.modelo")
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "ec.edu.upse.proyinv.modelo" });
